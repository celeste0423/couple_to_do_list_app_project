class Constants {
  ...
  //카톡 채널 페이지
  static String kakaoChannel = "http://pf.kakao.com/_uElNG";

  //카톡 1대1 문의사항
  static String kakaoQuestionChat = "http://pf.kakao.com/_uElNG/chat";
  ...
  static String adminWebAppUrl =
      'https://script.google.com/macros/s/AKfycbz76UyRBsYkZCX_PZDdijpdO9j-y_aOomkE_Mj_U3suwuL5pTM7a6BO4omKK5qj10pS/exec';
}
